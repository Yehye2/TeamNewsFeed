...
async function updateLoginStatus() {
  ...
  if (loggedIn) {
    ...
    loginSignup.remove();
    temp.id = "logout";
    temp.innerHTML = `<a id="popular" class="category_btn" onclick="logout()" href="/">로그아웃</a>`;
    navMenu.append(temp);
  } else {
    // 안했을때
    ...
    myPage.remove();
    logout.remove();
    temp.id = "login-signup";
    temp.innerHTML = `<a class="category_btn" href="/login">로그인/회원가입</a>`;
    navMenu.append(temp);
  }
}
